...
export function StudentProfileForm({
  ...
  onSubmit,
  onReset,
}: StudentProfileFormProps): React.JSX.Element {
  const helperMessage = validationError || error || syncWarning;
  const helperTone = validationError || error ? "text-destructive" : "text-amber-700";
  ...
  return (
    <Card className="rounded-3xl border-border/70 bg-card/95 py-0 shadow-none">
      ...
      <CardContent className="space-y-6 px-6 pb-6">
        ...
        >
          <div className="space-y-2">
            <Label htmlFor="student-profile-full-name">Full Name</Label>
            <Input
