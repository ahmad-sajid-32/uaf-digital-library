...
import { StudentDeleteAccountDialog } from "@/components/student-profile/student-delete-account-dialog";
...
function StudentProfileFailureState(props: {
  heading: string;
  message: string;
    ...
    >
      <div className="flex flex-1 flex-col gap-6">
        {profileState.loading ? (
          ...
          <StudentProfileFailureState
            heading="Unable to resolve your protected profile."
            message="The current self-service profile screen needs authenticated student identity state before it can render or submit real account mutations."
