            ...
            <Card className="rounded-[2rem] border-border/60 bg-card/95 py-0 shadow-none">
              <CardHeader className="gap-2 border-b border-border/60 px-6 py-5">
                <div className="space-y-2">
                  ...
                  <CardDescription className="max-w-3xl px-0 text-sm leading-6 text-muted-foreground">
                    A clean, visible summary of your current library activity, holds, fines, and academic result highlights.
                  </CardDescription>
                </div>
              </CardHeader>
              <CardContent className="grid gap-4 px-6 py-6 lg:grid-cols-[1.5fr_0.9fr]">
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    <div className="rounded-[1.5rem] border border-border/60 bg-background/55 p-4">
                      ...
                      <p className="mt-3 text-3xl font-black text-foreground">
                        {dashboard.summary.active_borrow_count}
                      </p>
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Books currently due or borrowed under your account.
                      </p>
                    </div>
                    <div className="rounded-[1.5rem] border border-border/60 bg-background/55 p-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                      ...
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Loans that need immediate attention.
                      </p>
                    </div>
                    <div className="rounded-[1.5rem] border border-border/60 bg-background/55 p-4">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                      ...
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Outstanding fine records still visible in your account.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="grid gap-4">
                  <div className="rounded-[1.5rem] border border-border/60 bg-background/55 p-4">
                    ...
                    <p className="mt-3 text-xl font-black text-foreground">
                      {dashboard.next_due_borrow ? dashboard.next_due_borrow.title : "No due date pending"}
                    </p>
                    <p className="mt-2 text-sm leading-6 text-muted-foreground">
                      {dashboard.next_due_borrow
                        ? getStudentBorrowDuePresentation(dashboard.next_due_borrow.due_date).helper
                        : "Your active borrow workspace is clear for now."}
                    </p>
                  </div>
                  <div className="rounded-[1.5rem] border border-border/60 bg-background/55 p-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">
                    ...
                    <p className="mt-3 text-xl font-black text-foreground">
                      {dashboard.current_hold ? dashboard.current_hold.title : "No hold ready"}
                    </p>
                    <p className="mt-2 text-sm leading-6 text-muted-foreground">
                      {dashboard.current_hold
                        ? `Expires ${formatStudentQueueDateTime(dashboard.current_hold.hold_expires_at)}`
                        : "You have no active hold assignment."}
                    </p>
                  </div>
                </div>
              </CardContent>
